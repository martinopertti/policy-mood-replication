...
+ `R/01-pmood-estimation.R`: this script estimate the Uruguayan policy mood using the raw data file
+ `R/02-figures.R`: this script creates the paper's figures using the pmood data file and president's ideology dataframe
